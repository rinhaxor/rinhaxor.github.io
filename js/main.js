...
// var gRows = Math.floor($(".stars").innerWidth()/tilesize);
// var gCols = Math.floor($('.stars').innerHeight()/tilesize);
...
//   var $SmallStarsI = $('<div/>').addClass("star");
//   $SmallStarsI.css({
//     'position':'absolute',
//     'left':(xpos[i] * tilesize)+'px',
//     'top':(ypos[i] * tilesize)+'px'
//   }).appendTo( '.stars' ).html(d);  

//   var SmallStarsII = $('<div/>').addClass("star-bottom");
//   SmallStarsII.css({
//     'position':'absolute',
//     'left':(xpos[i] * tilesize)+'px',
//     'top':(ypos[i] * tilesize)+'px'
...
//   var $BigStarsI = $('<div/>').addClass("bigstar");
//   $BigStarsI.css({
//     'position':'absolute',
...
//   var $BigStarsII = $('<div/>').addClass("bigstar-bottom");
//   $BigStarsII.css({
//     'position':'absolute',
//     'left':(xpos[i] * tilesize*3)+'px',
//     'top':(ypos[i] * tilesize*3)+'px'
